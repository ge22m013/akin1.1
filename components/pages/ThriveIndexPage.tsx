...
import { CpuChipIcon, UserGroupIcon, ChartBarIcon, LightBulbIcon, ShieldCheckIcon, SparklesIcon } from '@heroicons/react/24/outline';

const pillars = [
  { name: 'Technology', points: 100, items: ['Core Infrastructure & Platforms (25)', 'Intelligent Automation & AI Integration (45)', 'Cybersecurity & Digital Resilience (30)'], icon: CpuChipIcon },
  { name: 'Humanity', points: 100, items: ['Holistic Well-being & Support (30)', 'DEIB & Empowered Culture (40)', 'Dynamic Talent Development (30)'], icon: UserGroupIcon },
  { name: 'Results', points: 100, items: ['Financial Health & Profitability (50)', 'Market Position & Competitiveness (30)', 'Next-Gen Operational Efficiency (20)'], icon: ChartBarIcon },
  { name: 'Innovation', points: 100, items: ['Innovation Engine & R&D (40)', 'Culture of Continuous Experimentation (30)', 'Strategic Adaptability & Agility (30)'], icon: LightBulbIcon },
  { name: 'Valiant', points: 100, items: ['Clarity & Boldness of Vision (40)', 'Ethical Leadership & Governance (30)', 'Strategic Foresight & Risk-Taking (30)'], icon: ShieldCheckIcon },
  { name: 'Exceptional', points: 100, items: ['Customer Experience & Loyalty (50)', 'Product/Service Quality & Excellence (30)', 'Brand Reputation & Ecosystem Impact (20)'], icon: SparklesIcon },
];
                ...
                {pillars.map(pillar => (
                    <Card key={pillar.name} className="flex flex-col">
                        <div className="flex items-center gap-4">
                            <pillar.icon className="h-10 w-10 text-akin-cyan flex-shrink-0" />
                            <div>
