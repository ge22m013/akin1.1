            ...
            <main className="py-20 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                 <section className="bg-gray-50 p-8 md:p-12 rounded-lg">
                    <div className="grid md:grid-cols-3 gap-8 items-center">
                        <div className="md:col-span-1 text-center">
                            <LightBulbIcon className="h-24 w-24 mx-auto text-akin-cyan" />
                            <h2 className="mt-4 text-3xl font-extrabold text-akin-text-dark">Our Viewpoint</h2>
                        </div>
                        <div className="md:col-span-2">
                             <p className="text-xl text-akin-text-light italic">
                ...
                <section className="mt-24">
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-akin-text-dark">The Impact of Architected Intelligence</h2>
                     ...
                     <div className="mt-16 grid gap-8 md:grid-cols-3">
                        <Card className="text-center">
                            <ShieldCheckIcon className="h-12 w-12 mx-auto text-akin-cyan" />
                            <h3 className="mt-4 text-xl font-bold">Real-Time Fraud Detection</h3>
                            <p className="mt-2 text-akin-text-light">Analyze millions of transactions in milliseconds to detect subtle patterns of fraud and prevent losses before they occur.</p>
                        </Card>
                         <Card className="text-center">
                            <DocumentMagnifyingGlassIcon className="h-12 w-12 mx-auto text-akin-cyan" />
                            <h3 className="mt-4 text-xl font-bold">Automated Compliance</h3>
                            <p className="mt-2 text-akin-text-light">Ensure continuous compliance with AML and KYC regulations by intelligently monitoring transactions and customer data in real-time.</p>
                        </Card>
                         <Card className="text-center">
                            <ScaleIcon className="h-12 w-12 mx-auto text-akin-cyan" />
                            <h3 className="mt-4 text-xl font-bold">Dynamic Risk Scoring</h3>
                            <p className="mt-2 text-akin-text-light">Develop bespoke AI models that provide a more accurate and adaptive assessment of credit and market risk.</p>
                        </Card>
                    </div>
                </section>
            </main>
