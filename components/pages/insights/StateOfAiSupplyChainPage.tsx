    ...
    return (
        <div>
            ...
            <main className="py-20 md:py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="prose prose-lg max-w-none text-akin-text-light prose-headings:text-akin-text-dark prose-strong:text-akin-text-dark">
                        ...
                        <Card key={finding.title}>
                            <div className="flex items-start gap-4">
                                <div className="flex-shrink-0">
                                    <finding.icon className="h-10 w-10 text-akin-cyan" />
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-akin-text-dark">{finding.title}</h3>
                                    <p className="mt-1 text-akin-text-light">{finding.text}</p>
                                </div>
                            </div>
                        </Card>
                    ))}
                ...
                <div className="prose prose-lg max-w-none text-akin-text-light prose-headings:text-akin-text-dark prose-strong:text-akin-text-dark mt-16">
