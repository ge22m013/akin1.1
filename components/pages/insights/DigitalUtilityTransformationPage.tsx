            ...
            <main className="py-20 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <section>
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-akin-text-dark">The Challenge: A System Under Pressure</h2>
                ...
                <section className="mt-24">
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-akin-text-dark">The Solution: The AI Operating System</h2>
                         <p className="mt-4 max-w-3xl mx-auto text-lg text-akin-text-light">
