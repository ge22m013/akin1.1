    ...
    return (
        <div>
            <Hero
                ...
                title="Phase 5: Collaborate & Evolve"
                subtitle="We adopt a product mindset, not a project mindset. Your AI platform is a living asset that must constantly evolve to deliver sustained, long-term value."
            />

            <section className="py-20 md:py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-akin-text-dark">A Partnership for the Future</h2>
                        <p className="mt-4 max-w-3xl mx-auto text-lg text-akin-text-light">
                           The launch of your platform is the beginning of our journey together, not the end. In this phase, we transition into a long-term partnership focused on continuous improvement and value creation. We work with your team to monitor, refine, and deploy new capabilities, ensuring your investment grows over time.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-gray-50 py-20 md:py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                     <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-akin-text-dark">Our Evolution Model</h2>
                        <p className="mt-4 max-w-3xl mx-auto text-lg text-akin-text-light">
