    ...
    return (
        <div>
            ...
            <main className="py-20 md:py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="prose prose-lg max-w-none text-akin-text-light prose-headings:text-akin-text-dark prose-strong:text-akin-text-dark prose-a:text-akin-cyan hover:prose-a:text-akin-text-dark">
                    ...
                    <p>We use cookies and similar technologies to optimize the viewing experience, analyze traffic, and better serve content. You can manage your preferences through our cookie consent banner. For more details, please review our cookie policy when it becomes available.</p>
