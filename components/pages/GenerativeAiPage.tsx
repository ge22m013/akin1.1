    ...
    return (
        <div>
            <Hero
                ...
                subtitle="We move Generative AI beyond the chatbot. Our bespoke platforms build intelligent agents grounded in your unique operational reality, transforming GenAI from a feature into a core capability."
            />

            <section className="py-20 md:py-32">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-akin-text-dark">The Enterprise Generative AI Challenge</h2>
                    <p className="mt-4 text-lg text-akin-text-light max-w-3xl mx-auto">The promise of GenAI is immense, but enterprise adoption is stalled by critical, foundational problems that simple API calls cannot solve.</p>
                    <div className="mt-12 grid md:grid-cols-3 gap-8 text-left">
                        {challenges.map(challenge => (
                            <Card key={challenge.title} className="text-center h-full">
                                <challenge.icon className="h-12 w-12 mx-auto text-akin-cyan" />
            ...
            <section className="bg-gray-50 py-20 md:py-32">
                <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        <SparklesIcon className="h-16 w-16 text-akin-cyan mb-4" />
            ...
            <section className="py-20 md:py-32">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-extrabold text-akin-text-dark">Enterprise Use Cases, Powered by Akin</h2>
                    <p className="mt-4 text-lg text-akin-text-light max-w-3xl mx-auto">Unlock new capabilities that drive tangible business value.</p>
                    <div className="mt-12 grid md:grid-cols-3 gap-8 text-left">
                        {useCases.map(useCase => (
                            <Card key={useCase.title} className="h-full">
                                <useCase.icon className="h-10 w-10 text-akin-cyan mb-4" />
